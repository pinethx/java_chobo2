...
//		arrayToFill();
//		arrayToList();		
//		arrayToBinarySearchBySrot();
		
		Student[] stdArr = {
				new Student(1, "이종윤", 90, 90, 90),
				new Student(5, "김길언", 80, 79, 68),
				new Student(3, "박유찬", 78, 91, 55),
	...
	public static void arrayToBinarySearchBySrot() {
...
//		System.out.println(arList);
	...
	public static void arrayToFill() {
		 ...
		 * 
		 * @Override public int applyAsInt(int operand) { return
